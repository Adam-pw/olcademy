...
import { TextInput, createStyles, Button, Textarea } from '@mantine/core';
  ...
  return (
    <>
      <div className={styles.main}>
        <div className={styles.left}><b> Welcome to Olcademy </b></div>
        <div className={styles.right}>
          ...
          <Textarea
            ...
            autoComplete="nope"
          />
          <Button radius="lg" className={styles.button} onClick={addContact}>Submit</Button>
        </div>
      </div>
    </>
  );
